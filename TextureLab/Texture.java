...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private void triangularPrism(GL2 gl2) {
		...
		gl2.glBegin(GL2.GL_TRIANGLES);  // top triangular face - texture coordinates
		gl2.glNormal3d(0,1,0);
		gl2.glTexCoord2d(0, 0);
		gl2.glVertex3d(-t,0.5,-0.25);
		gl2.glTexCoord2d(1.0/3.0, 0);
		gl2.glVertex3d(t,0.5,-0.25);
		gl2.glTexCoord2d(0, 1.0/3.0);
		gl2.glVertex3d(0,0.5,0.5);
		gl2.glEnd();
		
		gl2.glBegin(GL2.GL_TRIANGLES);  // bottom triangular - texture coordinates
		gl2.glNormal3d(0,-1,0);
		gl2.glTexCoord2d(1, 0);
		gl2.glVertex3d(t,-0.5,-0.25);
		gl2.glTexCoord2d(1, 1.0/3.0);
		gl2.glVertex3d(-t,-0.5,-0.25);
		gl2.glTexCoord2d(2.0/3.0, 1.0/3.0);
		gl2.glVertex3d(0,-0.5,0.5);
		gl2.glEnd();
		
		gl2.glBegin(GL2.GL_QUADS); // front left face - texture coordinates
		gl2.glNormal3d(-0.75,0,t);
		gl2.glTexCoord2d(0, 1);
		gl2.glVertex3d(-t, 0.5, -0.25);
		gl2.glTexCoord2d(1.0/3.0, 1);
		gl2.glVertex3d(0, 0.5, 0.5);
		gl2.glTexCoord2d(1.0/3.0, 0);
		gl2.glVertex3d(0, -0.5, 0.5);
		gl2.glTexCoord2d(0, 0);
		...
		gl2.glBegin(GL2.GL_QUADS); // front right face - texture coordinates
		gl2.glNormal3d(0.75,0,t);
		gl2.glTexCoord2d(1.0/3.0, 1);
		gl2.glVertex3d(0, 0.5, 0.5);
		gl2.glTexCoord2d(1.0/3.0, 0);
		gl2.glVertex3d(0, -0.5, 0.5);
		gl2.glTexCoord2d(2.0/3.0, 0);
		gl2.glVertex3d(t, -0.5, -0.25);
		gl2.glTexCoord2d(2.0/3.0, 1);
		gl2.glVertex3d(t, 0.5, -0.25);
		gl2.glEnd();
		
		gl2.glBegin(GL2.GL_QUADS); // back face - texture coordinates
	...
	private Texture textureFromResource(String resourceName) {
		...
		// BufferedImage is loaded from a resource file\
		// load image
		URL textureURL;
	...
	private Texture textureFromPainting() {
		...
		GL2 gl2 = context.getGL().getGL2();
		// texture is created from a BufferedImage containing a copy of the drawing
		// from the paint panel
